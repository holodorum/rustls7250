...
#[derive(Debug)]
/// An exemplar `ResolvesServerCert` implementation that always resolves to a single raw public key.
pub struct AlwaysResolvesServerRawPublicKeys(pub Arc<sign::CertifiedKey>);
