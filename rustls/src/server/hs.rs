...
impl ExtensionProcessing {
    ...
    fn validate_server_cert_type_extension(
        ...
        let client_allows_rpk = hello
            ...
            .unwrap_or(false);
        let raw_key_negotation = cx
            .common
            .validate_rpk_negotiation(RawKeyNegotiationParams {
        ...
        self.process_cert_type_extension(raw_key_negotation, cx)
    }
    ...
    fn process_cert_type_extension(
        ...
        match raw_key_negotiation_result {
            ...
            RawKeyNegotationResult::Negotiated(_) => {
                unreachable!();
            }
        }
        Ok(())
